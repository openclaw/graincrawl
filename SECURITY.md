...
archives, database rows, tokens, note bodies, transcripts, or emails in reports.

## Scope

In scope:

- local Granola archive, cache, SQLite, and filesystem handling
...
- Granola service outages, API changes, or account enforcement decisions
